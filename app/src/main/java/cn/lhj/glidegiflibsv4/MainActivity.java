...
//        ImageGifLoader.display(this,url,iv, FrameSequenceDrawable.LOOP_INF);
        ...
        ImageGifLoader.display(this,url1,iv2, FrameSequenceDrawable.LOOP_INF);
        ImageGifLoader.display(this,url1,iv3, FrameSequenceDrawable.LOOP_INF);
        ImageGifLoader.display(this,url1,iv4, FrameSequenceDrawable.LOOP_INF);
    }
}
